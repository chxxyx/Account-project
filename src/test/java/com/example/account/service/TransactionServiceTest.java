...
class TransactionServiceTest {
    ...
    void useFailed_AccountNotFound() {
        // given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    void useFailed_userUnMatch() {
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(Account.builder()
                        .accountUser(harry) // 찾은 계좌의 소유주가 다를 때
                        .balance(0L)
                        .accountNumber("1000000012").build()));
    ...
    void deleteAccountFailed_alreadyUnRegistered() {
        ...
        given(accountRepository.findByAccountNumber(anyString()))
                .willReturn(Optional.of(Account.builder()
                        .accountUser(pobi) // 찾은 계좌의 소유주가 다를 때
    ...
    @Test
    @DisplayName("거래 할 금액과 취소 금액이 다름 - 잔액 사용 취소 실패")
    ...
    @Test
    @DisplayName(" 사용 취소 기한은 1년 - 잔액 사용 취소 실패")
